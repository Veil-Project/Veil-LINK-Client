...
window.promptForInput = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, electron_prompt_1.default(__assign(__assign({}, options), { parentWindow: electron_1.remote.BrowserWindow, customStylesheet: path_1.default.join(__dirname, 'prompt.css') }))];
